...
This file lists all notable changes to this project. The format follows
...
### Added
- **Prose linting via `vale` (errata-ai/vale v3.17.1).** The shared agent image now includes the Vale CLI and an ASD-STE100 style. The new `vale_lint` tool and `/vale` command check generated text for ASD-STE100 compliance. Rules: `SentenceLength`, `PassiveVoice`, `Contractions`, `Shall`, `IngForms`. Rule changes rebuild project images.
