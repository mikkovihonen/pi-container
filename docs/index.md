...
Coverage is measured against `src/`, `pi-coding-agent-proxy/addons/allowlist`, and `pi-coding-agent-proxy/addons/token_replacer`. The badge is auto-generated by CI on each release.
